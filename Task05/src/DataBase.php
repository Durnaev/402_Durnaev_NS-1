...
namespace Durnaev\guessnumber\DataBase;

use function Durnaev\guessnumber\View\outputGamesInfo;
use function Durnaev\guessnumber\View\outputTurnInfo;
use function Durnaev\guessnumber\View\outputGamesInfoTop;
use RedBeanPHP\R;
